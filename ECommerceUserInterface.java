		...
		try {
			while (scanner.hasNextLine())
			{
				...
				else if (action.equalsIgnoreCase("CANCEL")) // Cancel an existing order
				{
					...
					else if (action.equalsIgnoreCase("PRINTCART")) // Print all the items in the Cart
					{
						String customerId = "";
					...
					else if (action.equalsIgnoreCase("REMCARTITEM")) // Remove items from the cart
					{
						String customerId = "";
						String productId  = "";
					...
					else if (action.equalsIgnoreCase("ORDERITEMS")) // Order items from the cart
				{
					String customerId = "";
